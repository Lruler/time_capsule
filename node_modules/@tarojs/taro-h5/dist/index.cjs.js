...
window.addEventListener('DOMSubtreeModified', function (e) {
  var _a; // eslint-disable-next-line @typescript-eslint/ban-ts-ignore
  // @ts-ignore
...
function createRouter(app, config, framework) {
  ...
  var render = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(location, action) {
      var _a, _b, _c, element, pageConfig, enablePullDownRefresh, shouldLoad, prev, el, _config, page;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              if (shouldLoad) {
                ...
                delete _config['path'];
                delete _config['load'];
                page = runtime.createPageConfig(enablePullDownRefresh ? (_c = runtime.CurrentReconciler.createPullDownComponent) === null || _c === void 0 ? void 0 : _c.call(runtime.CurrentReconciler, el, location.pathname, framework) : el, location.pathname + runtime.stringify(qs()), {}, _config);
...
var ENV_TYPE$1 = Taro.ENV_TYPE,
    ...
    noPromiseApis$1 = Taro.noPromiseApis,
    onAndSyncApis$1 = Taro.onAndSyncApis,
    otherApis$1 = Taro.otherApis,
    Link$1 = Taro.Link,
...
var taro = {
  ...
  switchTab: switchTab,
  noPromiseApis: noPromiseApis$1,
  onAndSyncApis: onAndSyncApis$1,
  otherApis: otherApis$1,
  Link: Link$1,
...
taro.interceptors = interceptors$1;
...
var pageScrollTo = function pageScrollTo(_ref) {
  ...
  return new Promise(function (resolve, reject) {
    try {
      ...
      var from = scrollFunc();
      var to = scrollTop || document.querySelector(selector).offsetTop;
      var delta = to - from;
...
exports.noPromiseApis = noPromiseApis$1;
...
exports.onAndSyncApis = onAndSyncApis$1;
