        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.pages.forEach(page => {
                ...
                if (config) {
                    ...
                    const importCustomWrapperPath = helper_1.promoteRelativePath(path.relative(page.path, path.join(this.options.sourceDir, this.getTargetFilePath(customWrapperName, ''))));
