...
exports.getDevtool = exports.getOutput = exports.getEntry = exports.getModule = exports.getProviderPlugin = exports.getMiniPlugin = exports.getCopyWebpackPlugin = exports.getCssoWebpackPlugin = exports.getTerserPlugin = exports.getDefinePlugin = exports.getMiniCssExtractPlugin = exports.getMiniTemplateLoader = exports.getBabelLoader = exports.getFileLoader = exports.getUrlLoader = exports.getStylusLoader = exports.getLessLoader = exports.getSassLoader = exports.getPostcssLoader = exports.getCssLoader = exports.processEnvOption = exports.mergeOption = exports.makeConfig = void 0;
...
exports.getModule = (appPath, { sourceDir, designWidth, deviceRatio, buildAdapter, isBuildQuickapp, 
...
enableSourceMap, compile, cssLoaderOption, lessLoaderOption, sassLoaderOption, stylusLoaderOption, fontUrlLoaderOption, imageUrlLoaderOption, mediaUrlLoaderOption, postcss, fileType }) => {
    ...
    const scssLoader = exports.getSassLoader([{
            sourceMap: true,
            implementation: sass,
            sassOptions: {
                outputStyle: 'expanded'
...
exports.getEntry = ({ sourceDir, entry, isBuildPlugin }) => {
    ...
    Object.keys(pluginConfig).forEach(key => {
        if (key === 'main') {
            ...
            entryObj[`plugin/${fileName}`] = [helper_1.resolveMainFilePath(filePath.replace(path.extname(filePath), ''))];
        }
