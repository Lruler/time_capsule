...
const core = require('./core-f14a7ffd.js');
...
const VideoControl = class {
    ...
    render() {
        ...
        if (!showPlayBtn) {
            ...
            playBtn = core.h("div", { class: 'taro-video-control-button taro-video-control-button-pause', onClick: pauseFunc });
        }
        else {
            playBtn = core.h("div", { class: 'taro-video-control-button taro-video-control-button-play', onClick: playFunc });
        }
        return (core.h(core.Host, { class: 'taro-video-bar taro-video-bar-full' }, controls && (core.h("div", { class: 'taro-video-controls' }, playBtn, showProgress && (core.h("div", { class: 'taro-video-current-time', ref: dom => (this.currentTimeRef = dom) }, formatTime(currentTime))), showProgress && (core.h("div", { class: 'taro-video-progress-container', onClick: this.onClickProgress }, core.h("div", { class: 'taro-video-progress', ref: ref => {
                if (!ref)
                    return;
                const rect = ref.getBoundingClientRect();
                this.progressDimentions.left = rect.left;
                this.progressDimentions.width = rect.width;
            } }, core.h("div", { class: 'taro-video-progress-buffered', style: { width: '100%' } }), core.h("div", { class: 'taro-video-ball', ref: dom => (this.progressBallRef = dom), onTouchStart: this.onDragProgressBallStart, style: {
                left: `${formattedDuration ? (this.currentTime / duration) * 100 : 0}%`
            } }, core.h("div", { class: 'taro-video-inner' }))))), showProgress && core.h("div", { class: 'taro-video-duration' }, formattedDuration))), core.h("slot", null)));
    }
    get controlsRef() { return core.getElement(this); }
};
...
const Video = class {
    constructor(hostRef) {
        ...
        this.onFullScreenChange = core.createEvent(this, "fullscreenchange", 7);
        this.onProgress = core.createEvent(this, "progress", 7);
        this.onLoadedMetaData = core.createEvent(this, "loadedmetadata", 7);
    }
    componentWillLoad() {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: index$1.classNames('taro-video-container', {
                'taro-video-type-fullscreen': isFullScreen
            }), onTouchStart: this.onTouchStartContainer, onClick: this.onClickContainer }, core.h("video", { class: 'taro-video-video', style: {
                'object-fit': objectFit
            }, ref: dom => {
                if (dom) {
                    this.videoRef = dom;
                }
            }, src: src, autoplay: autoplay, loop: loop, muted: muted, poster: controls ? poster : undefined, playsinline: true, "webkit-playsinline": true, onPlay: this.handlePlay, onPause: this.handlePause, onEnded: this.handleEnded, onTimeUpdate: this.handleTimeUpdate, onError: this.handleError, onDurationChange: this.handleDurationChange, onProgress: this.handleProgress, onLoadedMetaData: this.handleLoadedMetaData }, "\u6682\u65F6\u4E0D\u652F\u6301\u64AD\u653E\u8BE5\u89C6\u9891"), core.h("taro-video-danmu", { ref: dom => {
                if (dom) {
                    this.danmuRef = dom;
                }
            }, enable: _enableDanmu }), isFirst && showCenterPlayBtn && !isPlaying && (core.h("div", { class: 'taro-video-cover' }, core.h("div", { class: 'taro-video-cover-play-button', onClick: () => this.play() }), core.h("p", { class: 'taro-video-cover-duration' }, durationTime))), core.h("taro-video-control", { ref: dom => {
                if (dom) {
                    this.controlsRef = dom;
                }
            }, controls: controls, currentTime: this.currentTime, duration: this.duration || this._duration || undefined, isPlaying: this.isPlaying, pauseFunc: this._pause, playFunc: this._play, seekFunc: this._seek, showPlayBtn: this.showPlayBtn, showProgress: this.showProgress }, showMuteBtn && (core.h("div", { class: index$1.classNames('taro-video-mute', {
                'taro-video-type-mute': isMute
            }), onClick: this.toggleMute })), danmuBtn && (core.h("div", { class: index$1.classNames('taro-video-danmu-button', {
                'taro-video-danmu-button-active': _enableDanmu
            }), onClick: this.toggleDanmu }, "\u5F39\u5E55")), showFullscreenBtn && (core.h("div", { class: index$1.classNames('taro-video-fullscreen', {
                'taro-video-type-fullscreen': isFullScreen
            }), onClick: this.onClickFullScreenBtn }))), core.h("div", { class: 'taro-video-toast taro-video-toast-volume', ref: dom => {
                if (dom) {
                    this.toastVolumeRef = dom;
                }
            } }, core.h("div", { class: 'taro-video-toast-title' }, "\u97F3\u91CF"), core.h("div", { class: 'taro-video-toast-icon' }), core.h("div", { class: 'taro-video-toast-value' }, core.h("div", { class: 'taro-video-toast-value-content', ref: dom => {
                if (dom) {
                    this.toastVolumeBarRef = dom;
                }
            } }, core.h("div", { class: 'taro-video-toast-volume-grids' }, Array(10).fill(1).map(() => (core.h("div", { class: 'taro-video-toast-volume-grids-item' }))))))), core.h("div", { class: 'taro-video-toast taro-video-toast-progress', ref: dom => {
                if (dom) {
                    this.toastProgressRef = dom;
                }
            } }, core.h("div", { class: 'taro-video-toast-title', ref: dom => {
                if (dom) {
...
const VideoDanmu = class {
    ...
    render() {
        if (!this.enable)
            return '';
        return (core.h(core.Host, { class: 'taro-video-danmu' }, this.danmuList.map(({ text, color, bottom, key }) => (core.h("p", { class: 'taro-video-danmu-item', key: key, style: {
                color,
                bottom
            }, ref: ref => {
                if (ref) {
