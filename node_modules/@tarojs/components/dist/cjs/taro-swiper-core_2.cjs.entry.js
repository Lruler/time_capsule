...
const Swiper$1 = class {
    constructor(hostRef) {
        ...
        this.onAnimationFinish = core.createEvent(this, "animationfinish", 7);
    }
    watchCurrent(newVal) {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: `taro-swiper-${this._id}`, style: hostStyle }, core.h("div", { class: 'swiper-container', style: style }, core.h("style", { type: 'text/css' }, `
            ...
            `), core.h("div", { class: 'swiper-wrapper' }, core.h("slot", null)), core.h("div", { class: index$1.classNames('swiper-pagination', {
...
const SwiperItem = class {
    ...
    render() {
        return (core.h(core.Host, { class: 'swiper-slide', "item-id": this.itemId }));
    }
};
