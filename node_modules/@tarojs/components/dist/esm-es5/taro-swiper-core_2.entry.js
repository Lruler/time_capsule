...
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './core-f216d924.js';
...
var Virtual = {
    update: function (force) {
        var swiper = this;
        var _a = swiper.params, slidesPerView = _a.slidesPerView, slidesPerGroup = _a.slidesPerGroup, centeredSlides = _a.centeredSlides;
        var _b = swiper.params.virtual, addSlidesBefore = _b.addSlidesBefore, addSlidesAfter = _b.addSlidesAfter;
        var _c = swiper.virtual, previousFrom = _c.from, previousTo = _c.to, slides = _c.slides, previousSlidesGrid = _c.slidesGrid, renderSlide = _c.renderSlide, previousOffset = _c.offset;
        swiper.updateActiveIndex();
        ...
        prependIndexes.sort(function (a, b) { return b - a; }).forEach(function (index$$1) {
    ...
    prependSlide: function (slide) {
        ...
        if (swiper.params.virtual.cache) {
            ...
            Object.keys(cache_1).forEach(function (cachedIndex) {
                newCache_1[cachedIndex + 1] = cache_1[cachedIndex];
            });
...
var Parallax = {
    ...
    setTransition: function (duration) {
        ...
        $el.find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]')
            .each(function (index$$1, parallaxEl) {
...
var Lazy = {
    loadInSlide: function (index$$1, loadInDuplicate) {
...
var Controller = {
    ...
    setTranslate: function (setTranslate, byController) {
        var swiper = this;
...
var History = {
    ...
    getPathValues: function () {
        var pathArray = win$1.location.pathname.slice(1).split('/').filter(function (part) { return part !== ''; });
    ...
    scrollToSlide: function (speed, value, runCallbacks) {
        ...
        if (value) {
            for (var i = 0, length = swiper.slides.length; i < length; i += 1) {
                var slide_3 = swiper.slides.eq(i);
                var slideHistory = History.slugify(slide_3.attr('data-history'));
                if (slideHistory === value && !slide_3.hasClass(swiper.params.slideDuplicateClass)) {
                    var index$$1 = slide_3.index();
...
var HashNavigation = {
    ...
    setHash: function () {
        ...
        if (swiper.params.hashNavigation.replaceState && win$1.history && win$1.history.replaceState) {
            ...
            var slide_4 = swiper.slides.eq(swiper.activeIndex);
            var hash = slide_4.attr('data-hash') || slide_4.attr('data-history');
    ...
    init: function () {
        ...
        if (hash) {
            var speed = 0;
            for (var i = 0, length = swiper.slides.length; i < length; i += 1) {
                var slide_5 = swiper.slides.eq(i);
                var slideHash = slide_5.attr('data-hash') || slide_5.attr('data-history');
                if (slideHash === hash && !slide_5.hasClass(swiper.params.slideDuplicateClass)) {
                    var index$$1 = slide_5.index();
...
var Coverflow = {
    setTranslate: function () {
        var swiper = this;
        var swiperWidth = swiper.width, swiperHeight = swiper.height, slides = swiper.slides, $wrapperEl = swiper.$wrapperEl, slidesSizesGrid = swiper.slidesSizesGrid;
...
var INSTANCE_ID = 0;
var Swiper$1 = /** @class */ (function () {
    function Swiper$1(hostRef) {
    ...
    Swiper$1.prototype.watchCurrent = function (newVal) {
    ...
    Swiper$1.prototype.watchAutoplay = function (newVal) {
    ...
    Swiper$1.prototype.watchDuration = function (newVal) {
        this.swiper.params.speed = newVal;
    };
    Swiper$1.prototype.watchInterval = function (newVal) {
        this.swiper.params.autoplay.delay = newVal;
    };
    Swiper$1.prototype.watchSwiperWrapper = function (newVal) {
        if (!newVal)
            return;
    ...
    Swiper$1.prototype.componentDidLoad = function () {
        var _a = this, autoplay = _a.autoplay, current = _a.current, interval = _a.interval, duration = _a.duration, circular = _a.circular, vertical = _a.vertical, displayMultipleItems = _a.displayMultipleItems;
    ...
    Swiper$1.prototype.componentWillUpdate = function () {
    ...
    Swiper$1.prototype.render = function () {
        var _a = this, vertical = _a.vertical, indicatorDots = _a.indicatorDots, indicatorColor = _a.indicatorColor, indicatorActiveColor = _a.indicatorActiveColor;
        var hostStyle = { overflow: 'hidden' };
        var style = { overflow: 'visible' };
        if (this.full) {
            hostStyle.height = '100%';
            style.height = '100%';
        }
        var _b = /^(\d+)px/.exec(this.previousMargin) || [], previousMargin = _b[1];
        var _c = /^(\d+)px/.exec(this.nextMargin) || [], nextMargin = _c[1];
        var pM = parseInt(previousMargin) || 0;
        var nM = parseInt(nextMargin) || 0;
        if (vertical) {
    ...
    Object.defineProperty(Swiper$1.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Swiper$1, "watchers", {
        get: function () {
            return {
    ...
    Object.defineProperty(Swiper$1, "style", {
...
var SwiperItem = /** @class */ (function () {
    function SwiperItem(hostRef) {
        registerInstance(this, hostRef);
    }
    SwiperItem.prototype.render = function () {
