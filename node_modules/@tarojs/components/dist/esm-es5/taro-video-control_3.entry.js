...
import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './core-f216d924.js';
...
var Video = /** @class */ (function () {
    function class_2(hostRef) {
            ...
            if (_this.gestureType === 'none') {
                ...
                if (Math.abs(distY) >= Math.abs(distX)) {
                    ...
                    if (_this.enableProgressGesture) {
                        ...
                        _this.lastPercentage = _this.currentTime / ((_a = _this.duration) !== null && _a !== void 0 ? _a : _this._duration);
                    }
                    else {
                        return obj;
                    }
        ...
        this._play = function () { return _this.videoRef.play(); };
        this._pause = function () { return _this.videoRef.pause(); };
        this._stop = function () {
        ...
        this.handleFullScreenChange = function (e) {
            ...
            if (!e.detail && _this.isFullScreen && !document[screenFn.fullscreenElement] && timestamp - _this.fullScreenTimestamp > 100) {
                _this.toggleFullScreen(false);
            }
        };
        this.toggleFullScreen = function (isFullScreen) {
            if (isFullScreen === void 0) { isFullScreen = !_this.isFullScreen; }
            _this.isFullScreen = isFullScreen;
            _this.controlsRef.toggleVisibility(true);
            _this.fullScreenTimestamp = new Date().getTime();
            _this.onFullScreenChange.emit({
                fullScreen: _this.isFullScreen,
                direction: 'vertical'
            });
            if (_this.isFullScreen && !document[screenFn.fullscreenElement]) {
                setTimeout(function () {
                    _this.videoRef[screenFn.requestFullscreen]({ navigationUI: 'show' });
                }, 0);
            }
        };
    ...
    /** 跳转到指定位置 */
    class_2.prototype.seek = function (position) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                this._seek(position);
                return [2 /*return*/];
    ...
    class_2.prototype.requestFullScreen = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
    ...
    /** 退出全屏 */
    class_2.prototype.exitFullScreen = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
    ...
    class_2.prototype.render = function () {
        ...
        return (h(Host, { class: classNames('taro-video-container', {
            ...
            }, enable: _enableDanmu }), isFirst && showCenterPlayBtn && !isPlaying && (h("div", { class: 'taro-video-cover' }, h("div", { class: 'taro-video-cover-play-button', onClick: function () { return _this.play(); } }), h("p", { class: 'taro-video-cover-duration' }, durationTime))), h("taro-video-control", { ref: function (dom) {
                if (dom) {
                ...
                'taro-video-type-fullscreen': isFullScreen
            }), onClick: this.onClickFullScreenBtn }))), h("div", { class: 'taro-video-toast taro-video-toast-volume', ref: function (dom) {
                if (dom) {
                    _this.toastVolumeRef = dom;
                }
            } }, h("div", { class: 'taro-video-toast-title' }, "\u97F3\u91CF"), h("div", { class: 'taro-video-toast-icon' }), h("div", { class: 'taro-video-toast-value' }, h("div", { class: 'taro-video-toast-value-content', ref: function (dom) {
                if (dom) {
                    _this.toastVolumeBarRef = dom;
                }
            } }, h("div", { class: 'taro-video-toast-volume-grids' }, Array(10).fill(1).map(function () { return (h("div", { class: 'taro-video-toast-volume-grids-item' })); }))))), h("div", { class: 'taro-video-toast taro-video-toast-progress', ref: function (dom) {
                if (dom) {
                    _this.toastProgressRef = dom;
                }
            } }, h("div", { class: 'taro-video-toast-title', ref: function (dom) {
                if (dom) {
...
var VideoDanmu = /** @class */ (function () {
    ...
    class_3.prototype.render = function () {
        ...
        if (!this.enable)
            return '';
        return (h(Host, { class: 'taro-video-danmu' }, this.danmuList.map(function (_c) {
